...
class BaseMCFlowNetwork {
 public:
    ...
    virtual NetworKit::node addNode(int ex = 0) = 0;
    virtual void addEdge(NetworKit::node s, NetworKit::node t, int cost = 0, std::int64_t capacity = 0) = 0;
    ...
    virtual void setCost(NetworKit::node s, NetworKit::node t, int cost) = 0;
...
class MCFlowNetwork : public BaseMCFlowNetwork {
    ...
    std::unordered_map<NetworKit::Edge, int> cost;
 ...
 public:
    ...
    virtual NetworKit::node addNode(int ex = 0) override;
    virtual void addEdge(NetworKit::node s, NetworKit::node t, int cost = 0, std::int64_t capacity = 0) override;
    ...
    virtual void setCost(NetworKit::node s, NetworKit::node t, int cost) override;
